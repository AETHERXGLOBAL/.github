...
The following properties apply across the architecture rather than to only one layer.
...
The intended institutional pattern is:
...
- AETHER X Intelligence Chain

All public material remains subject to explicit claim, security and intellectual-property boundaries.
